...
class LoadFormsByLastSyncTask: OPLYNXUserServerTask {
    ...
    init(viewController: UIViewController?, run: Run) {
        ...
        super.init(module: "of", method: "getbylinksforclient", httpMethod: "GET", viewController: viewController, taskTitle: "Data Sync", taskDescription: "Loading Updated Forms")
