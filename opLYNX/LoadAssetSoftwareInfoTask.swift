...
class LoadAssetSoftwareInfoTask: OPLYNXAssetServerTask {
    ...
    init?(_ syncType: String, viewController: UIViewController?) {
        ...
        super.init(module: "asset", method: "loadassetsoftwareinfo", httpMethod: "GET", viewController: viewController, taskTitle: syncType, taskDescription: "Loading Asset Software Info")
